...
func TestNotLikeSpecification_IsEmpty(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
...
func TestNotLikeSpecification_Query(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
...
func TestNotLikeSpecification_Values(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
