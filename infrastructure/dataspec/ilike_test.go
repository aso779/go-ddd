...
func TestILikeSpecification_IsEmpty(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
...
func TestILikeSpecification_Query(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
...
func TestILikeSpecification_Values(t *testing.T) {
	type fields struct {
		field Field
		value string
	}
