...
func TestIsNullSpecification_IsEmpty(t *testing.T) {
	type fields struct {
		field Field
	}
	tests := []struct {
...
func TestIsNullSpecification_Query(t *testing.T) {
	type fields struct {
		field Field
	}
	type args struct {
...
func TestIsNullSpecification_Values(t *testing.T) {
	type fields struct {
		field Field
	}
	tests := []struct {
